<?php
class Bookings_CommissionpaymentController extends Zend_Controller_Action {
	...
	public function indexAction(){
		try{
			$db = new Bookings_Model_DbTable_DbCommission();
...
// 			Application_Form_FrmMessage::redirectUrl("/booking/carrentalbooking/add");
		...
		$frm = new Bookings_Form_FrmCommission();
	...
	function getcarbookingbyagencyAction(){
		if($this->getRequest()->isPost()){
			$data = $this->getRequest()->getPost();
			$db_com = new Bookings_Model_DbTable_DbCommission();
